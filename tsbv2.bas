...
1700 DIM PL$(79),PP$(3),PC$(8),CF$(6),T$(9),PT$(3),PA$(1)
...
17626  IF NOT OK THEN MOBCOL 5,2:END PROC: REM GOTO 17699

#17630  CALCPLASIZE

#      WILL BE 110% IF PLANTATION TOUCHES WATER (STAGE 2 IMMEDIATELY)
17642  PRINT AT(11,32) PEEK($CA03)"%";
#      SIZE
...
#      INSUFFICIENT FUNDS
17650  IF PD(CP,1)-M < 0 THEN OK=0:MOBCOL 5,2:FCOL 16,29,9,1,2:END PROC:REM GOTO 17699
...
# DRAW PLANTATION FIELD
#17750  FILL T(0),T(1),T(2),T(3),T(4),T(5)
# DRAW PLANTATION BUILDING
