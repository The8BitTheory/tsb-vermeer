...
# REU(PRINT AT) AT 1 MHZ: 226 JIFFIES/C64
...
# UTACHTEN
14720  IF ID=1 THEN TX$="AS GEHT NOCH NICHT":BOXWITHTEXTL:OGALSEL:END PROC

# ERKAUFEN
14730  IF ID=2 THEN TX$="AS GEHT NOCH NICHT":BOXWITHTEXTL:OGALSEL:END PROC
...
#       IF YEAR HAS CHANGED, SHOW NEW YEAR'S RAFFLE (IF DT%(2)>1918 THEN)
22620   IF DT%(0)=1 THEN IF DT%(1)=1 THEN OTOM:FILL 0,0,40,25,0,15:OTRIPS
...
23595  TX$="QC="+STR$(QC)+",PRD:"+STR$(ID)+",VOL:"+STR$(RV):BOXWITHTEXTL
23596  KEYGET I$
...
23610  TX$="ORWARD ONTRACTS":BOXWITHTEXTL
...
58275  TV=TC+TX*3:TL=PEEK(TV):TX$=DUP(" ",TL):SP=.*LEN(TX$)+D!PEEK(71)
58276  Z=D!PEEK(SP+1)

#58280  Q=TC+D!PEEK(TV+1):D!POKE$5A,Q:D!POKE$58,Z:POKE781,1:POKE782,TL:SYS $A3EC
58280  MEMDEFTL,Z,D!PEEK(TV+1),0:MEMLOAD
58281  PRINT AT(BY+CY,BX+CX) TX$;
...
58979  TX$="UFR]UMEN...":BOXWITHTEXTL
58980  X=FRE(.)
