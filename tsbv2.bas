...
1052  DIM M$(31),F%(1,6),BD$,I,I1,DT%(3),DC(11),TR$(13),P(1),SC%(8,1,3),SE%(1,4,3)
...
1479  DT%(0)=1:DT%(1)=1:DT%(2)=1918:DT%(3)=0
...
6845  IF GS(1)=25 THEN OBANCRE:END PROC
...
58489  IF GS(1)=23 THEN IBANRED:END PROC
58490  IF GS(1)=24 THEN IBANDOL:END PROC
58491  IF GS(1)=25 THEN IBANCRE:END PROC
