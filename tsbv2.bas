...
1012  DIM M$(17),F%(1,6),BD$,I,I1,DT(2),DC(11),TR$(19),P(1),SC(14,1,3),SE(1,4,3)
...
22636    IF TV=0 THEN LARRTRA:ELSE T$(PX)=INST(CHR$(TV),T$(PX),1)
...
#      T$: PUT TRANSPORT-INDEX BACK INTO AVAILABLE LIST
23030  T$(PX)="":T$=T$+CHR$(PX)

23040  IF LEN(PT$(CP))=1 THEN PT$(CP)="":END PROC

23050  TV=PLACE(CHR$(PX),PT$(CP)):T1=LEN(PT$(CP))

23060  IF TV=1 THEN PT$(CP)=MID$(PT$(CP),2):GOTO 23099

23070  IF TV=T1 THEN PT$(CP)=LEFT$(PT$(CP),T1-1):GOTO 23099
...
58496  IF GS(1)=16 THEN ITRAPRO:END PROC
58497  IF GS(1)=17 THEN IOVE:END PROC
