...
3 IF RV THEN POKE $BDA3,PEEK($C3E6):POKE$BDA9,PEEK($C3E5):ELSE D!POKE $C3E5,D!PEEK($AE)
4 POKE $C530,0:CHECK
...
12 IF ME=1 THEN MEMDEF BL,TT,$8000,0:MEMSAVE:GOTO20
13 IF ME=2 THEN SYS MD+9,BL,TT,0,$8000,5
...
8392  IF NY=1 THEN SYS MD+6:END
8395  NY=1:LOAD"NY"
8399  END
