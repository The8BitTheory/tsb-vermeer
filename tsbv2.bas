...
15 IFE=0THENE=1:PRINT"ADE EXTKONSTANTEN":LOAD"TEXTCONST",USE,0,TC
...
23345    SA=0*LEN(T$(PX))+D!PEEK(71):SA=D!PEEK(SA+1):POKE SA,TV
...
58275  TV=TC+TX*3:TL=PEEK(TV)

58280  Q=TC+D!PEEK(TV+1):D!POKE$5A,Q:D!POKE$58,Z:POKE781,1:POKE782,TL:SYS $A3EC
#58280  MEMDEFTL,Z,D!PEEK(TV+1),0,0,0:MEMLOAD
#58280  PRINT AT(BY+CY,BX+CX) TT$(TX);
