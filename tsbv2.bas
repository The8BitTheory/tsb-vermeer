...
# AA()
# AD()
1032  DIMP1,P2,D1,D2,HO,HI,BC,CD,SV,PB,TS,AA,SA,LV,NY,RV
...
6933  MEMDEF 4,NL,GS(1)*4,0,0,0:MEMLOAD:GOTO 6937
6934  SYS MD+9,4,GS(1)*4,5,NL,0
...
#14310  BX=1:BY=4:BW=38:BH=13:FRAME
...
14360  NLREU:POKE NL+GS(1)*4+3,LEN(AC$(CP,AC))
