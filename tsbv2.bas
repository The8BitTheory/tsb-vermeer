...
22620   IF DT%(0)=1 THEN IF DT%(1)=1 THEN OTOM
...
# RAFFLE STANDING
28070  MOB SET 1,8,1,128,0,0:MMOB 1,XM(2)+80,YM(2)+50
# BINGO 1
28080  MOB SET 2,9,1,128,0,0:MMOB 2,XM(2)+95,YM(2)+50
# BINGO 2
28090  MOB SET 3,10,1,128,0,0:MMOB 3,XM(2)+95,YM(2)+50

28100  MOBON1

28105  T1=TI:REPEAT

28110  MOBON2:MOBOFF3
28115  TS=TI:REPEAT:UNTIL TI-TS>5
28120  MOBOFF2:MOBON3
