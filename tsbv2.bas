...
1015  DIM M$(14),F%(1,6),BD$,I,I1:F=11:FS=12:FB=6:IL=10:ID=0:MI=0:CP=0
...
6902  PRINT AT(BY+1,BX+1) TX$(PD(CP,0),0);
...
9040  PRINT AT(BY+4,BX+1) TT$(VAL(TX$(PD(CP,0),1)));
9050  PRINT AT(BY+5,BX+1) TT$(VAL(TX$(PD(CP,0),2)));
...
10010  IF ID<21 THEN PD(CP,0)=ID
