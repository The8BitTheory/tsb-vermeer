...
100 POKE56,120:COLOUR0,0,1:CA=$E800:NL=31232:FA=30720:TC=31744
101 IFA=0THENA=1:MEM:PRINT"ADE EICHENSATZ":LOAD"CHARSET.V2",USE,0,CA
102 IFB=0THENB=1:PRINT"ADE PRITES":LOAD"SPRITES",USE,0,$C000
103 IFC=0THENC=1:PRINT"ADE AVLABELS":LOAD"NAVLABELS",USE,0,NL
104 IFD=0THEND=1:PRINT"ADE AHMEN":LOAD"FRAMES",USE,0,FA
105 IFE=0THENE=1:PRINT"ADE EXTKONSTANTEN":LOAD"TEXTCONST",USE,0,TC
108 IF PEEK(828)<>$AD THEN PRINT"ADE AUSTREIBER":LOAD"MAUS.DRV",USE,0,$0334

#109 MEMDEF 1024,$7C00,0,0,0,0:MEMSAVE
...
1105 FORX=0TO24:YO(X)=40*X:NEXT
...
# BLOCK COPY AT 1 MHZ: 191 JIFFIES/MEGA, 221 JIFFIES/C64

# REU AT 1 MHZ: 202 JIFFIES
...
14290  IF ID>7 THEN ID=0:FCC:SCREEN:END PROC

14295  GS(1)=32:SCREEN
...
58255  TX=PEEK(F4+3):Z=DISPLAY+(YO(BY+PEEK(F4+1)))+BX+PEEK(F4+2)
58264  GOTO 58275

# HERE, TX IS COMING FROM OUTSIDE
58265 PROC CPX
#58270  Z=DISPLAY+YO(BY+CY)+BX+CX
