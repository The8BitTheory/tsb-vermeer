...
1012  DIM M$(14),F%(1,6),BD$,I,I1,DT(2),DC(11)
...
22270  PRINT AT(BY+1,BX+1)  "BFAHRT: PIELER"CP"IN "TX$(PD(0,0),0);
...
22340   PRINT AT(3,2) "OCH"PD(0,3)"AGE";
