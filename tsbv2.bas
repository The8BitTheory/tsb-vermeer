...
100 COLOUR0,0,1:CA=$E800:NL=$C200
...
14010  LDCHDR
14015  BX=1:BY=4:BW=38:BH=13:FRAME
...
14510  IF ID<LEN(AC$(CP,AC)) THEN AS=ID:OGALSEL:END PROC
...
# UTACHTEN
14720  IF ID=1 THEN END PROC

# ERKAUFEN
14730  IF ID=2 THEN END PROC

#BX=27:BY=20-OC:BW=FN NW(.)+2:BH=3+OC:FRAME
14790  ID=AC:FILL 17,27,13,7,0,15:OGALCAT
