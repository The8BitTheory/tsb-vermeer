...
20145  QC=1:OSELQUA:IF RV=0 THEN 20168

#      T2:PRODUCE
20146  T2=VAL(TX$(PD(CP,0),ID+1)):
20147  LBOOKTRANSPORT

20150  TV=SC%(PD(CP,0)-6,ID,CP)-RV:IF TV<0 THEN TV=0
20152  SC%(PD(CP,0)-6,ID,CP)=TV
...
21034   PRINT AT(BY+1+PX,BX+10) SE%(PD(CP,0),PX,CP);
21039  NEXT
...
23581  IF QC=1 THEN LBOOKTRANSPORT:GOTO 23585
