...
16045  IF PI=0 THEN END PROC

16050  FOR PX=0 TO PI-1
16055   PL$=PL$(PX)
16060   FOR IX=0 TO 3
16065    T(IX)=ASC(MID$(PL$,IX+1,1))
16070   NEXT
16075   FILL T(0),T(1),T(2),T(3),42,1
16080  NEXT
...
17735  T(0)=SY/8-8:T(1)=SX/8-5:T(2)=6:T(3)=6:T(4)=ID+97
