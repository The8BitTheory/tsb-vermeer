...
# $C64D - 50765: 256 BYTES DMA WORKING MEMORY -> $C74D 51021
# $E800 - 59392: CHARSET
...
20 POKE56,124:COLOUR0,0,1:CA=$E800:FA=$C64D:TC=$7A00:NL=$C64D:N4=NL+4:FM=124*256
...
58192  BY=PEEK(FM+$15):BX=PEEK(FM+$16):BW=PEEK(FM+$17):BH=PEEK(FM+$18)
58199 END PROC
