...
# PP%(CITY-ID,PRODUCE-ID): PRICES FOR PRODUCE IN PLANTATION-CITIES
# PE%(CITY-ID,PRODUCE-ID): PRICES FOR PRODUCE IN EMPORIUM-CITIES
1052  DIM M$(31),F%(1,6),BD$,I,I1,DT(2),DC(11),TR$(13),P(1),SC%(8,1,3),SE%(1,4,3)
1054  DIM LV%(8,3,2),WK%(8,3,1),PC(8,3,1),PP%(8,1),PE%(1,3),LQ%(3),QE(3),RR%(4)
...
1635  M$(29)="REDITE":M$(30)="ILGEN":M$(31)="UFNEHMEN"
...
1700 DIM PL$(179),PP$(3),PC$(8),CF$(4),PR(179),T$(9),PT$(3),PA$(1)
...
6824  IF GS(1)=4 THEN OBANCRE:END PROC
6825  IF GS(1)=100 THEN OHOT:END PROC
...
6843  IF GS(1)=23 THEN OBANRED:END PROC
6844  IF GS(1)=24 THEN OBANDOL:END PROC
...
12001  GS(1)=100:OC=2:REM OC=FN NC(.)
12010  LDCHDR
...
######################
# BANK - CREDITS (4) #
#           4 BECAUSE IT TOOK THE PLACE OF THE TRAVEL MENU
######################
25500 PROC OBANCRE
25505  GS(1)=4
...
58495  IF GS(1)=23 THEN HANDLECHOICE:END PROC
58496  IF GS(1)=24 THEN HANDLECHOICE:END PROC

#      IDS OVER 25 DONT HAVE NAVIGATION TARGET OR LABELS SET STATICALLY
58498  IF GS(1)=100 THEN IHOT:END PROC
