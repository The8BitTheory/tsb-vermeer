...
# $C200 - 49664: NAVLABELS (512 BYTES) -> $C31A

# $C3E7 - END OF USABLE MEMORY
# $E800 - 59392: CHARSET

100 POKE56,120:COLOUR0,0,1:CA=$E800:NL=$C200:FA=30720
...
14499 PRINT AT(0,18) D!PEEK(51)-D!PEEK(49):END PROC
...
14819  IF RI THEN AS=FNAS(AI):GOTO 14810
