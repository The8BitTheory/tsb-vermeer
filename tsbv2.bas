...
20 POKE56,123:COLOUR0,0,1:CA=$E800:FA=$C64D:TC=$7A00:NL=$C3C0:N4=NL+4:FM=123*256
...
8392  IF NY=1 THEN SYSFM+15:END
8395  NY=1:LOAD"NY"
8399  END
...
58190 PROC FRS
58192  BY=PEEK(FM+$15):BX=PEEK(FM+$16):BW=PEEK(FM+$17):BH=PEEK(FM+$18):END PROC
