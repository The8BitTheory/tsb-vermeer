...
110 INIT:STARTGAME:X=FRE(.):SCREEN:MENUE
...
1700 DIM PL$(179),PP$(3),PC$(8),CF$(6),PR(179),T$(9),PT$(3),PA$(1)
...
9120  PRINT AT(BY+2,BX+1) TT$(VAL(TX$(PD(CP,0),1)))"PLANTAGEN";
9125  USE AT(BY+2,BX+17) CF$(1),T(0);
9130  PRINT AT(BY+3,BX+1) TT$(VAL(TX$(PD(CP,0),2)))"PLANTAGEN";
...
25015  PRINT AT(BY+1,BX+1) "ONATSBERICHT: "TT$(T1+4)T2
...
#      PRINT STOCK NAMES
25140  FOR X=0 TO 3
25150   PRINT AT(BY+3+X,BX+1) TT$(17+X);
