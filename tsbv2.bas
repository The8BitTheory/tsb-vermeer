...
# $7800 (30720): ML-ROUTINE FOR FRAMES - 501 BYTES
# $7A00 (31232): TEXT CONSTANTS - 1536 BYTES (MORE THAN 1024 BYTES CURRENTLY WITH 94 ENTRIES)
# $0400 (1024): NAVLABELS - 285 BYTES WITH 32 NAV DEFS
# FOLLOWING   : FRAMEDATA - 563 BYTES WITH 36 FRAME DEFS
...
# TT:TXTTAB. START OF BACIC PROGRAM TEXT
...
20 POKE56,120:COLOUR0,0,1:CA=$E800:FA=$0400:TC=$7A00:NL=D!PEEK($FB):FM=$7800
...
1056  F=11:FS=12:FB=6:ID=0:MI=0:RL=0
...
8208  CX=1:CY=1:TX=68:CPX:REM PRINT AT(BY+1,BX+1) "UKTIONSTERMINE:";
...
25010 SYS FM,27,T1+3:FR=27:FRS
