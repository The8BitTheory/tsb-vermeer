...
1012  DIM M$(14),F%(1,6),BD$,I,I1,DT(2),DC(11),TR$(19),P(1)
...
1040  DIM XM(2),YM(2),T(10):XM(2)=24:YM(2)=50
...
20030  USE AT(BY+3,BX+12) CF$(3),235;
20032  USE AT(BY+3,BX+20) CF$(3),123;
...
20054  USE AT(BY+3,BX+23) "###/",111
20056  USE AT(BY+3,BX+27) "###T",246
20058  USE AT(BY+3,BX+31) CF$(4),888

20060  BX=19:BY=19:BW=20:BH=5:FRAME
20062  PRINT AT(BY+1,BX+1) "RANSPORT ONDON";
20064  PRINT AT(BY+2,BX+1) "RANSPORT EW ORK";
20066  PRINT AT(BY+3,BX+1) "USGANG";
...
#        PLANTATION. TV=SIZE OF PLANTATION (TV=TEMP VALUE):CT=TOWN OF PLANTATION
22810    PL$=PL$(PX):TV=ASC(MID$(PL$,8,1)):WK=TV:CT=ASC(MID$(PL$,10,1))
