...
4 CHECK
# $C62C: CLEAR TSB'S PROC STACK (BUILT BY CHECK)
...
12 MEMDEF BL,TT,0,BB:MEMSAVE

# FM:FRAME MACHINELANGUAGE ROUTINE
20 POKE56,119:COLOUR0,0,1:CA=$E800:FA=$0400:TC=$7A00:NL=D!PEEK($FB):FM=119*256

100 MEMDEF 1024,TC,0,0,0,0:MEMSAVE
105 IF NL=0 THEN NL=D!PEEK($FB)
110 INIT:STARTGAME
...
6913  CX=1
# TODO: GET NAVLABELS FROM REU. CALCULATE PARAMETERS AND DO MEMDEF,MEMLOAD
#     FILL THE MENU
...
17044  SYSFM,FR,VX%(0),VX%(1):FRS:ID=0:TAG
17049 END PROC
...
# TODO: GET NAVTARGETS FROM REU. CALC PARAMETERS AND DO MEMDEF,MEMLOAD
58505  TV=FN NT(ID)
