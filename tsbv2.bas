...
# AC%(PLAYER-ID,ARTCAT-ID):ART COUNT. HOW MANY A PLAYER OWNS PER CATEGORY
...
1103 AC%(0,0)=3:AN$(0,0)=CHR$(0)+CHR$(1)+CHR$(2)
...
#7001  SCRLD DEF $CC,4,0,2:SCRLD 1,USE,2,"OUTPUT.BIN":SCRLD RESTORE
...
#9001  SCRLD DEF $CC,4,0,2:SCRLD 1,USE,2,"FLOWER.BIN":SCRLD RESTORE
...
14026   USE AT(BY+I1+2,BX+28) CF$(6),AC%(CP,I1)
...
14315  PRINT AT(BY+1,BX+1) AK$(ID);

14390  ID=0:CHOICEMENU
...
14990  IF ID>2 THEN GS(1)=5:ID=0:SCREEN
