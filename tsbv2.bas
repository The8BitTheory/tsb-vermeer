...
1055  DIM YO(74),AK(39),AD%(2,1),PB%(3),AR$(39,2),AK$(7),AC$(3,7),VX%(1)
...
9110  VX%(0)=VAL(TX$(C6,1)):VX%(1)=VAL(TX$(C6,2)):FR=3:FRN
...
9140  TV=LV%(CT,CP,2)>=0
9145  VX%(0)=TV+72:CY=1:CX=1
...
#+" "TT$(73);
9155  IF TV THEN PRINT AT(BY+2,BX+2) STR$(DT%(3)-LV%(CT,CP,2));:CY=2:CX=6:TX=73:CPX
