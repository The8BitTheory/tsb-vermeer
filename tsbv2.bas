...
# $7B00 (30464): ML-ROUTINE FOR FRAMES - UP TO 1280 BYTES - FM
# $0400 (1024): 1024 BYTES FREE. MAYBE USED FOR ML ROUTINES. MOVE REU/MEGA SPECIFIC ONES TO $7X00
...
# $C000 - 49152: 15 SPRITES (960 BYTES) -> 50048 ($C3C0)
# $C3C0 - $C3E7: 39 BYTES DMA WORKING MEMORY FOR NAVLABELS AND TARGETS. 14 NEEDED SO FAR
# $C3E7 - END OF USABLE MEMORY
# $C64D - 50765: 256 BYTES DMA WORKING MEMORY (TEXTCONSTS AND FRAMES) -> $C74D 51021

# $CA00 - $CBFF: 512 BYTES FOR X! AND MAP
...
17610  SYS FM+12,TX,TY:OK=PEEK($CB0A)>4:T(8)=PEEK($CB0A)
...
60020  IF ME=2 THEN SYS MD+9,256,$7F00,5,$C400,0
60030 END PROC
