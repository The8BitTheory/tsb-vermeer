...
#     LABELS
1100  RO%(0,0,0)=1:RO%(0,0,1)=10:RO%(0,0,2)=2:RO%(0,0,3)=4:RO%(0,0,4)=5:RO%(0,0,5)=17
1101  RO%(1,0,0)=1:RO%(1,0,1)=3 :RO%(1,0,2)=2:RO%(1,0,3)=4:RO%(1,0,4)=5:RO%(1,0,5)=17
1102  RO%(2,0,0)=1:RO%(2,0,1)=8 :RO%(2,0,2)=20:RO%(2,0,3)=2:RO%(2,0,4)=4:RO%(2,0,5)=9:RO%(2,0,6)=17
...
9150  BX=1:BY=12:BW=22:BH=11:FRAME
...
22240   IF PD(0,3)<=0 THEN TQ=-1:GOTO 22270

#       ADVANCE THE DAY
22250   LADVDAY

#       PRINT UPDATED TRAVEL DURATION
22260   USE AT(3,7) CF$(2),PD(0,3);

22270  UNTIL TQ

22280  FILL 20,2,36,3,32,1
22290  PRINT AT(BY+1,BX+1) "NKUNFT: PIELER"CP"IN "TX$(PD(0,2),0);
22300  USE AT(BY+2,BX+10) "##.",DT(0);:USE "##.",DT(1);:USE "####",DT(2);
