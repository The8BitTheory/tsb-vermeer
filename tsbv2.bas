...
# $7800 (30720): FRAMEDATA - 512 BYTES (408 WITH 33 FRAME DEFS)
# $7A00 (31232): NAVLABELS - 512 BYTES (285 WITH 32 NAV DEFS)


# $C000 - 49152: SPRITES (768 BYTES) -> 49919 ($C2FF)
#                3 MORE SPRITES FIT IN HERE
# $C3E7 - END OF USABLE MEMORY
# $E800 - 59392: CHARSET

10 POKE56,120:COLOUR0,0,1:CA=$E800:NL=31232:FA=30720:TC=1024
