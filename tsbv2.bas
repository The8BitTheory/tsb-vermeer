...
1040  DIM XM(2),YM(2),T(5):XM(2)=24:YM(2)=50
...
17575   TV=PEEK($CC00+(SX/8)+2+(SY/8*40)+5):PRINT AT(0,5) TV;
17576   IF TV<>96 THEN MOBCOL 5,2:ELSE MOBCOL 5,1
...
17735  T(0)=SY/8-8:T(1)=SX/8-5:T(2)=6:T(3)=6:T(4)=VAL(TX$(PD(0,0),ID+1))+97
