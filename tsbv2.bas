...
17506  PRINT AT(13,36) "HA"
17507  PRINT AT(15,28) "UMME"
17508  PRINT AT(16,37) "";
...
17640   MOBCOL 5,1
17642   PRINT AT(10,34) "100%";
17644   PRINT AT(13,32) HA;
17646   PRINT AT(16,29) " "(HA*291);
...
17733  T(6)=TY:T(7)=TX
17735  T(4)=VAL(TX$(PD(0,0),ID+1))+97
...
17772  T(0)=TY+4:T(1)=TX:T(2)=6:T(3)=6

17774  IF T(0)<6 THEN T(3)=6-(6-T(0)):T(0)=6
17776  IF T(1)<2 THEN T(2)=6-(2-T(1)):T(1)=2

17777  IF T(0)>17 THEN T(3)=6-(T(0)-17)
17778  IF T(1)>19 THEN T(2)=6-(T(1)-19)
