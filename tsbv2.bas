...
# BL:BASIC LENGTH
# MD:MEMORY-DMA: ADDRESS OF DMA-COPY ROUTINE
10 TT=D!PEEK($2B):VT=D!PEEK($2D):BL=VT-TT:ME=PEEK(1020):MD=$7EC0:MM=$7E00
...
6941  ML=OC+OC+2
# THE REU-ADDRESS USUALLY NEEDS TO ADD RA%(0,0), BUT THAT'S ZERO ANYWAYS
6942  SYS MD+15,ML,D!PEEK(NL),N4
...
8392  IF NY>0 THEN SYS MD+6:END
...
17610  SYS MM,2,TX,TY,PD(CP,0):OK=PEEK($CA04)>4:T(8)=PEEK($CA04)
...
#      DMA STASH
#      BASIC PROGRAM
60055  SYS MD+9,BL,TT,$8000
#      PROC TABLE
60060  SYS MD+9,256,$C400,$7F00
