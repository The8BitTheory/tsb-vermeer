...
# $7A00 (31232): FRAMEDATA - 1024 BYTES (509 WITH 35 FRAME DEFS)
# $7E00 (32256): NAVLABELS - 512 BYTES (285 WITH 32 NAV DEFS)
...
5 IF SI THEN PRINT "COMING BACK":MEMDEF VL,VA,VA,VB:MEMLOAD:TRACE ON:SCR:MENUE

10 POKE56,122:COLOUR0,0,1:CA=$E800:NL=$7E00:FA=$7A00:TC=$0400
...
24 IFD=0THEND=1:PRINT"ADE AHMEN":LOAD"FRAMES",USE,0,FA
...
1055  DIM YO(74),AK(39),AD%(2,1),PB%(3),AR$(39,2),AK$(7),AC$(3,7),VX%(1),VX(2)
...
#       IF YEAR HAS CHANGED, SHOW NEW YEAR'S RAFFLE ()
22620   IF DT%(0)=1 THEN IF DT%(1)=1 THEN IF DT%(2)>1918 THEN OTOM:FSB:OTRIPS
...
58473  IF GS(1)=3 THEN ITRA:END PROC
58474  IF GS(1)=9 THEN IWAR:END PROC
58475  IF GS(1)=10 THEN IMAR:END PROC
58476  IF GS(1)=11 THEN IGALSEL:END PROC
58477  IF GS(1)=4 THEN IHOT:END PROC
58478  IF GS(1)=5 THEN IGAL:END PROC
58479  IF GS(1)<12 THEN HANDLECHOICE:END PROC
...
58498 IF GS(1)=32 THEN IGALCAT:END PROC
