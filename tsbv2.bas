...
6934  IF ME=2 THEN SYS MD+15,4,GS(1)*4,NL
...
6943  IF ME=2 THEN SYS MD+15,ML,D!PEEK(NL),N4
...
60015  IF ME=2 THEN SYS MD+15,256,$7F00,$C400
...
60065  IF ME=2 THEN SYS MD+9,BL,TT,$8000
60070  RCOMP SYS MD+9,256,$C400,$7F00
