...
109 IF PEEK(828)<>$AD THEN PRINT"ADE AUSTREIBER":LOAD"MAUS.DRV",USE,0,$0334
...
58201  F2=FA+FR+FR
58202  F4=FA+D!PEEK(F2)
58204  BY=PEEK(F4):BX=PEEK(F4+1):BW=PEEK(F4+2):BH=PEEK(F4+3)
58206  FRAME
...
58255  TX=PEEK(F4+3)
58260  Z=DISPLAY+(40*(BY+PEEK(F4+1)))+BX+PEEK(F4+2)
58264  GOTO 58275

58265 PROC CPX
58270  Z=DISPLAY+40*(BY+CY)+BX+CX

58275  TV=TC+TX*3:TL=PEEK(TV):Q=TC+D!PEEK(TV+1)
58280  D!POKE $5A,Q:D!POKE$58,Z:POKE 781,1:POKE 782,TL
58285  SYS $A3EC

58299 END PROC

58300 PROC FRAME
58312  INSERT BD$,BY,BX,BW,BH,FB
58315  FILL BY+1,BX+1,BW-2,BH-2,32,1
58320  FCOL BY+BH,BX+1,BW,1,11
58325  FCOL BY+1,BX+BW,1,BH,11
58330 END PROC
