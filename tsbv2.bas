...
1056  F=11:FS=12:FB=6:ID=0:MI=0:AA$="QWERX"
...
8310  FORX=1TO4
8315   MMOB X,XM(2)+16,YM(2)+32*X:MOB SET X,6,1,0,0,0:PB%(X-1)=0
8320  NEXT

# COVERING THIS IN THE LOOP ABOVE
#8330  FORX=0TO3:PB%(X)=0:NEXT

#8335  KEYGET I$:I=PEEK(512)

8330  POKE $DC02,$FE
8335  I=(PEEK($DC01) AND $7F)
8340  PRINT AT(24,30) I;
...
#AA$=AUCTION ACTION KEYS
8342 PB=PLACE(I$,AA$)-1
8345 IF PB<0 THEN 8335:ELSE IF PB<4 THEN MOGUY:GOTO 8335:ELSE IF PB<>4 THEN 8335

#8340  IF I$="Q" THEN PB=0:MOGUY:GOTO 8335
#8345  IF I$="W" THEN PB=1:MOGUY:GOTO 8335
#8350  IF I$="E" THEN PB=2:MOGUY:GOTO 8335
#8355  IF I$="R" THEN PB=3:MOGUY:GOTO 8335
#8360  IF I$<>"X" THEN 8335
...
8365  CY=BH-2:CX=1:TX=75:CPX

8370  DO NULL

8375  MOBOFF1:MOBOFF2:MOBOFF3:MOBOFF4 
...
8410  PB%(PB)=PB%(PB)+1
8420  MMOB PB+1,XM(2)+16+PB%(PB),YM(2)+32*(PB+1)
8425  MOB SET PB+1,6+(PB%(PB)AND1),1,0,0,0
