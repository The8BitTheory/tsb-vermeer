...
#6920   PRINT AT(BY+I1+1,BX+1) TT$(TV);
#6920   
...
8365  PRINT AT(BY+BH-2,BX+1) "ASTE";
...
9120  TX=VAL(TX$(PD(CP,0),1)):CY=2:CX=11:CPX
9125  USE AT(BY+2,BX+17) CF$(1),T(0);

#9130  PRINT AT(BY+3,BX+11) TT$(VAL(TX$(PD(CP,0),2)));
9130  TX=VAL(TX$(PD(CP,0),2)):CY=3:CX=11:CPX
...
12032  PRINT AT(BY+2,BX+1) "BIS 1.";:TX=TV+3:CY=2:CX=5:CPX
...
58275  TV=TC+TX*3:TL=PEEK(TV):POKEMA,TL

58280  D!POKE$5A,TC+D!PEEK(TV+1):D!POKE$58,MP:POKE781,1:POKE782,TL:SYS $A3EC
