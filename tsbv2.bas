...
# $C367 - 50023: FRAMEDATA (128 BYTES)
# $C3E7 - END OF USABLE MEMORY
# $E800 - 59392: CHARSET

100 POKE56,120:COLOUR0,0,1:CA=$E800:NL=$C200:FA=$C367
...
18125  TX$=PA$(1):LRMVFROMSTR:PA$(1)=RV$
...
58204  F4=FA+FR+FR+FR+FR
58206  BY=PEEK(F4):BX=PEEK(F4+1):BW=PEEK(F4+2):BH=PEEK(F4+3)

58208 PROC FRAME
58212  INSERT BD$,BY,BX,BW,BH,FB
