...
1012  DIM M$(17),F%(1,6),BD$,I,I1,DT(2),DC(11),TR$(19),P(1),SC(14,1,3)
...
23010  T$(PX)="":T$=T$+CHR$(PX)

#23010  REM TODO: REMOVE TRANSPORT FROM PLAYER'S TRANSPORTS PT$(CP)

23020  TV=PLACE(CHR$(PX),PT$(CP))
23030  T$=INST("",CHR$(PX),PLACE)
...
23220 PROC LOVE
23222  TV=ASC(MID$(PT$(CP),X,1)):TV$=T$(TV)
