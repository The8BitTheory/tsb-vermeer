...
10005  IF ID>=15 OR ID=PD(CP,0) THEN ID=0:FCC:SCR:END PROC
...
12210  IF ID>1 THEN FCC:ID=0:SCR:END PROC
...
14290  IF ID>7 THEN ID=0:FCC:SCR:END PROC
...
14510  IF ID<LEN(AC$(CP,AC)) THEN AI=ID:AS=FNAS(AI):OGALSEL:END PROC
...
# NSEHEN
14710  IF ID=0 THEN OGALVIEW:END PROC

# UTACHTEN
14720  IF ID=1 THEN TX$="AS GEHT NOCH NICHT":BWTL:OGALSEL:END PROC

# ERKAUFEN
14730  IF ID=2 THEN TX$="AS GEHT NOCH NICHT":BWTL:OGALSEL:END PROC

14790  ID=AC:FILL 4,0,40,20,0,15:OGALCAT
...
14805  PRINT ""CHR$(142);:D!POKE 1022,D!PEEK($FB)
...
14825  D!POKE $FB,D!PEEK(1022):NLREU:NTREU:PRINT ""CHR$(14);

#################################
# RESTORE PREVIOUS SCREEN STATE #
#################################

#14822 ID=-1:GS(1)=32:LCHDR:SCREEN
...
18010  ISELECTPLA:IF PL<0 THEN GS(1)=8:SCR:END PROC
...
20110  IF ID>1 THEN ID=0:FCC:SCR:END PROC
...
# USGANG
21130  IF ID=3 THEN ID=0:FCC:SCR:END PROC
