...
10 POKE56,124:COLOUR0,0,1:CA=$E800:NL=$7E00:FA=$7C00:TC=1024
...
8424  SV=20
8425  CD=CD-1:IF CD<0 THEN 8490
...
8450 IF PB<0 THEN 8420
8460 IF PB<4 THEN MOGUY:GOTO 8420
8470 IF PB=4 THEN 8370
8480 IF PB<>5 THEN 8420
# BOX PUSHER 1
...
8490  CY=BH-2:CX=1:TX=75:CPX

8500  POKE198,0:DO NULL
...
8950  PB%(PB)=PB%(PB)+5:SA=TI:SV=60
...
58208  F4=F4+4:BA=PEEK(F4)

58215  IF BA=0 THEN END PROC

#58225  IF BA=1 THEN PRINT AT(BY+PEEK(F4+1),BX+PEEK(F4+2)) TT$(PEEK(F4+3));:GOTO 58208
58225  IF BA=1 THEN CPR:GOTO58208
#58230  IF BA=2 THEN USE AT(BY+PEEK(F4+1),BX+PEEK(F4+2)) TT$(PEEK(F4+3));:GOTO 58208
