...
17505  SX=24+16-3:SY=50+6*8-3

# SPRITE-NR,BLOCK,COLOR,PRIO,TYPE
# 1,1,BLACK,DONT SHOW,HIRES
17510  MOB SET 1,1,0,0,0:MMOB 1,SX,SY
17512  MOB SET 2,2,1,0,0:MMOB 2,SX,SY

17520  REPEAT
17521   KEYGET I$:I=PEEK(512)

17522   IF I=145 THEN SY=SY-8:GOTO 17528
17523   IF I=17 THEN SY=SY+8:GOTO 17528
17524   IF I=157 THEN SX=SX-8:GOTO 17528
17525   IF I=29 THEN SX=SX+8:GOTO 17528
17526   GOTO 17530

17528   MMOB 1,SX,SY:MMOB2,SX,SY
