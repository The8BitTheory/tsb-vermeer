...
10010  IF ID>=21 OR ID=PD(CP,0) THEN ID=0:FCC:SCREEN:END PROC
...
# AREHOUSE 9 #
#############
# WAREHOUSE IS AT THE EMPORIUM
# THE ONE AT THE PLANTATION CITY IS CALLED MARKETPLACE
20000 PROC OWAR
...
20145  QC=1:OSELQUA:IF RV=0 THEN 20148
...
# MARKETPLACE IS AT PLANTATION CITY
# THE ONE AT THE EMPORIUM IS CALLED WAREHOUSE
21000 PROC OMAR
21002  GS(1)=10
21005  LDCHDR
...
23560  IF QC=0 THEN T1=ID:ELSE IF QC=1 THEN T2=ID
...
23581  IF QC=1 THEN BOOKTRANSPORT:GOTO 23585

# QC=0 AT THIS LINE. SELL
23582  IF IP=4 THEN TV=SC%(TV,ID,CP):ELSE TV=I(0)*1000+I(1)*100+I(2)*10+I(3)

23585  TX$="QC="+STR$(QC)+",PRD:"+STR$(ID)+",VOL:"+STR$(TV):BOXWITHTEXT
