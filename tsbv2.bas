...
8310  FORX=1TO4
8315   MMOB X,XM(2)+32,YM(2)+3+32*X:MOB SET X,12,1,0,0,0:PB%(X-1)=0
8320  NEXT
# COVERING THIS IN THE LOOP ABOVE
#8330  FORX=0TO3:PB%(X)=0:NEXT

8325  FORX=0TO3:PRINT AT(BY+3+4*X,BX+1)PN$(X);:NEXT

8330  FR=33:FRN

8340  KEYGET I$:I=PEEK(512)
...
8345 IF PB<0 THEN 8340
8346 IF PB<4 THEN MOGUY:GOTO 8340
8347 IF PB<>4 THEN 8340
...
8410  PB%(PB)=PB%(PB)+1
8420  MMOB PB+1,XM(2)+32+PB%(PB),YM(2)+3+32*(PB+1)
...
58960  PN$(0)="ARTIN":PN$(1)="OOT":PN$(2)="MEGA":PN$(3)="NOOPY"
