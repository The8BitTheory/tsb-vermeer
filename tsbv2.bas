...
6840  IF GS(1)=20 THEN OSELQUA:END PROC
...
20286  IF IP=4 THEN RV=SC%(TV,ID,CP):ELSE RV=I(0)*1000+I(1)*100+I(2)*10+I(3)
...
# PRODUCE.
# COMES FROM OUTSIDE, AS BOOKTRANSPORT CAN BE CALLED FROM PLANTATION OR EMPORIUM
...
# TRANSPORT (T7=1): WRITE SELECTION TO T2
...
# WE'RE COMING FROM "ERKAUFEN"
23560  IF T7=0 THEN T1=ID:ELSE IF T7=1 THEN T2=ID

# WE'RE COMING FROM "RANSPORT"
23570  IF T7>1 THEN PRINT "T7 SHOULD BE 0 OR 1, BUT IS "T7:STOP

23580  OSELQUA


# T2 CONTAINS PRODUCE (FOR BOOKTRANSPORT)

23581  IF T7=1 THEN BOOKTRANSPORT:GOTO 23585

# T7=0 AT THIS LINE. SELL
23582  IF IP=4 THEN TV=SC%(TV,ID,CP):ELSE TV=I(0)*1000+I(1)*100+I(2)*10+I(3)

23585  TX$="T7="+STR$(T7)+",PRD:"+STR$(ID)+",VOL:"+STR$(TV):BOXWITHTEXT
23590  KEYGET I$:GS(1)=10:SCREEN
