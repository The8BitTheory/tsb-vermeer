...
# $7C00 (31744): FRAMEDATA - 512 BYTES (444 WITH 35 FRAME DEFS)
...
10 POKE56,124:COLOUR0,0,1:CA=$E800:NL=$7E00:FA=$7C00:TC=$0400
...
1055  DIM YO(74),AK(39),AD%(2,1),PB%(3),AR$(39,2),AK$(7),AC$(3,7)
...
6852  IF GS(1)=32 THEN OGALCAT:END PROC
...
6901  VX$(0)=PN$(CP)+" IN "+TX$(PD(CP,0),0)
6902  FR=1:FRN
...
#+" "TT$(73);
9155  RCOMP PRINT AT(BY+2,BX+2) STR$(DT%(3)-LV%(CT,CP,2)):CY=2:CX=6:TX=73:CPX
...
12032  PRINT AT(BY+2,BX+1) "BIS 1.";:TX=TV+3:CY=2:CX=7:CPX
...
17042  TX=VAL(TX$(PD(CP,0),1)):CY=1:CX=1:CPX
#17044  PRINT AT(BY+2,BX+1) TT$(VAL(TX$(PD(CP,0),2)));
17044  TX=VAL(TX$(PD(CP,0),2)):CY=2:CX=1:CPX
#17046  PRINT AT(BY+3,BX+1) TT$(21);
17046  TX=21:CY=3:CX=1:CPX
...
28140  PRINT AT(BY+9,BX+1) "ER REIS GEHT AN:";
...
#CENTER AT(BY+PEEK(F4+1),BX+PEEK(F4+2)) TT$(PEEK(F4+4)),PEEK(F4+3);:F4=F4+5:GOTO 58208
...
58310  PRINT AT(BY+CY,BX+CX) VX$(PEEK(F4+3));
