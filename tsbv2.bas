...
#
1140 DIM PL$(179),PP$(3),PC$(14),CF$(4),PR(179)
...
20058  USE AT(BY+3,BX+31) CF$(4),888

20060  BX=1:BY=18:BW=17:BH=5:FRAME
20062  PRINT AT(BY+1,BX+1) "RANSPORTDAUER";
20064  PRINT AT(BY+2,BX+1) "ONDON: XX AGE";
20066  PRINT AT(BY+3,BX+1) ": YY AGE";

20070  BX=19:BY=19:BW=20:BH=5:FRAME
20072  PRINT AT(BY+1,BX+1) "RANSPORT ONDON";
20074  PRINT AT(BY+2,BX+1) "RANSPORT EW ORK";
20076  PRINT AT(BY+3,BX+1) "USGANG";
...
20110  IF ID>1 THEN ID=0:FCC:SCREEN
20120 END PROC
