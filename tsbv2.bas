...
#
1140 DIM PL$(179),PP$(3),PC$(14),CF$(1):PI=0:CF$(0)="####### ":CF$(1)="## HA"
...
6904  USE AT(BY+1,BX+1) CF$(0),PD(0,1);
...
17710  IF ID=0 THEN LPLABOOK:GOTO 17720
#17715  IF ID=1 THEN 
#      RE-DRAW PLANTATION
17715  DRPLA
#       THIS WOULD JUST REMOVE THE DRAWN PLANTATION. BUT WE DO DRPLA INSTEAD
#17716  FILL T(0),T(1),T(2),T(3),96,5

#      REMOVE WINDOW WITH PURCHASE DATA
17720  FILL 5,27,13,13,0,15
