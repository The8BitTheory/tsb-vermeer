...
6838  IF GS(1)=18 THEN OMARSELL:END PROC
...
# ERKAUF
21110  IF ID=0 THEN OMARSELL:END PROC
...
# RANSPORT
# PREPARES VARIABLES FOR TRANSPORT HANDLING
#  (EG DESTINATION = LOCATION OF OTHER EMPORIUM)
21140  IF PD(CP,0)=0 THEN T6=1:ELSE T6=0
...
23340    IF TV=0 THEN LARRTRA:ELSE T$(PX)=INST(CHR$(TV),T$(PX),1)
...
#######################
# MPORIUM (10) ELL RODUCE (18)
23400 PROC OMARSELL
23402  GS(1)=18
23410  TX$="ELL RODUCE":BOXWITHTEXT
...
################
# EMPORIUM TRANSPORT PRODUCE SELECTION
# (TRANSPORT FROM ONE EMPORIUM TO THE OTHER)
23800 PROC OMARPRO
23805  GS(1)=20
23810  BX=30:BY=17:BW=9:BH=7:FRAME

#      CHOICE MENU FOR PRODUCE SELECTION
23820  FOR PX=0 TO 3
23830   PRINT AT(BY+1+PX,BX+1) TT$(PX);
23835  NEXT
23840  PRINT AT(BY+5,BX+1) M$(0);
...
# PRODUCE SELECTION FOR TRANSPORT TO OTHER EMPORIUM
23860 PROC IMARPRO

23865  IF ID>3 THEN GS(1)=10:SCREEN:END PROC
...
58492  IF GS(1)=18 THEN IMARSELL:END PROC
58493  IF GS(1)=19 THEN IMARDATE:END PROC
58494  IF GS(1)=20 THEN IMARPRO:END PROC
