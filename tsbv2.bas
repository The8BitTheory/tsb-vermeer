...
# $7700 (30464): ML-ROUTINE FOR FRAMES - UP TO 768 BYTES - FM
# $7A00 (31232): TEXT CONSTANTS - 1536 BYTES (MORE THAN 1024 BYTES CURRENTLY WITH 94 ENTRIES) - 3 BYTES PER OFFSET ENTRY (=282 B)
# $0400 (1024): FRAMEDATA - 563 BYTES WITH 36 FRAME DEFS - 2 BYTES PER OFFSET ENTRY (=72 B)
# FOLLOWING   : NAVLABELS - 285 BYTES WITH 32 NAV DEFS - 4 BYTES PER OFFSET ENTRY (=128 B)
# DIR ENTRIES 482 B IN TOTAL
...
5 IF RV THEN POKE $C62C,0:POKE $BE,PEEK($BA):GOTO 115
...
10 TT=D!PEEK($2B):VT=D!PEEK($2D):BL=VT-TT:BB=1:ME=PEEK(1020)
#12 MEMDEF BL,TT,4096,0:MEMSAVE

# FM:FRAME MACHINELANGUAGE ROUTINE
20 POKE56,119:COLOUR0,0,1:CA=$E800:FA=$0400:TC=$7A00:NL=$C64D:N4=NL+4:FM=119*256

#100 MEMDEF 1024,TC,0,0,0,0:MEMSAVE
#105 IF NL=0 THEN NL=$C64D
110 INIT:STARTGAME
...
1002  REM CHECK:REM MEMDEF 255,$C400,0,3:MEMSAVE
...
# AA()
# AD()
1032  DIMP1,P2,D1,D2,HO,HI,BC,CD

1050  DIM F%(1,6),BD$,I,I1,DT%(3),DC(11),TR$(13),P(1),SC%(8,1,3),SE%(1,4,3),RA%(2,1)
...
#     READ REU/MEGA65 ADDRESSES FOR NAVLABELS,FRAMES,TEXTCONSTANTS
1060  RA%(0,0)=D!PEEK(NL):RA%(0,1)=D!PEEK(NL+2)
1061  RA%(1,0)=D!PEEK(NL+4):RA%(1,1)=D!PEEK(NL+6)
1062  RA%(2,0)=D!PEEK(NL+8):RA%(2,1)=D!PEEK(NL+10)
...
#     FILL THE MENU
6925  FOR I1=0 TO OC:CY=I1+1:TX=FN NL(I1):CPX:NEXT
...
6934  SYSFM+12,4,GS(1)*4,5,NL,0
#6935  FORX=$79A9TO$79A9+11:PRINT $$PEEK(X)" ";:NEXT:PRINT
#6936  PRINT NL"="D!PEEK(NL)","PEEK(NL+2)","PEEK(NL+3)
# FOR GS(1), NL SHOULD CONTAIN 84 00 0A 06
...
6943  IF ME=2 THEN SYSFM+12,ML,D!PEEK(NL),5,N4,0:
# N4 (NL+4) SHOULD CONTAIN 16 03 1F 0A 17 04 19 06 18 05 1A 07 26 11
...
######
# AUCTION CODE LINES 50000-51000 #
###########
