...
6933  IF ME=1 THEN SYS MD+15,4,GS(1)*4,NL
...
6941  ML=OC+OC+2
# THE REU-ADDRESS USUALLY NEEDS TO ADD RA%(0,0), BUT THAT'S ZERO ANYWAYS
6942  IF ME=1 THEN SYS MD+15,ML,D!PEEK(NL),N4
...
60010  IF ME=1 THEN SYS MD+15,256,$7F00,$C400
60015  IF ME=2 THEN SYS MD+15,256,$7F00,$C400
60020  IF ME=3 THEN SYS MD+15,256,$7F00,$C400
60030 END PROC
...
60055  IF ME=1 THEN SYS MD+9,BL,TT,$8000
60060  RCOMP SYS MD+9,256,$C400,$7F00
