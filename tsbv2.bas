...
# $7800 (30720): FRAMEDATA - 512 BYTES
# $7A00 (31232): NAVLABELS - 512 BYTES

# $C000 - 49152: SPRITES (768 BYTES) -> 49848 ($C2B8)
...
108 IFD=0THEND=1:PRINT"ADE AHMEN":LOAD"FRAMES2",USE,0,FA
