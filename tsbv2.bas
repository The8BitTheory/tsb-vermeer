...
10 TT=D!PEEK($2B):VT=D!PEEK($2D):BL=VT-TT:BB=1:ME=PEEK(1020):MD=$7F00+9

# THIS COPIES THE CURRENT BASIC PROGRAM TO THE 
#  THIS WILL BE SWAPPED WITH THE OTHER BASIC PROGRAM ON-DEMAND
12 MEMDEF BL,TT,0,1:MEMSAVE

# FM:FRAME MACHINELANGUAGE ROUTINE
20 POKE56,127:COLOUR0,0,1:CA=$E800:FA=$C64D:TC=$7A00:NL=$C3C0:N4=NL+4:FM=$0400
...
8392  IF NY=1 THEN SYS$7F00+6:END
8395  NY=1:LOAD"NY"
8399  END
