...
1055  DIM YO(74),AK(39),AD%(2,1),PB%(3),AR$(39,2),AK$(7),AC$(3,7),VX%(1),VX(5)
...
# LOOKUP TABLE FOR Y OFFSETS ON SCREEN (Y*40)
1150 FORX=0TO24:YO(X)=DISPLAY+40*X:NEXT
...
13100  FR=9:SYSFM,FR
#13110  FOR X=0 TO 4
#13120   PRINT AT(BY+8,BX+1+7*X) TT$(X+16);
#13130  NEXT
...
25312   TX=17+I1:CY=I1+1:CX=1:CPX
25314  NEXT
...
#58494  IF GS(1)=28 THEN QC=5:IBANDOL
#58495  IF GS(1)=29 THEN QC=6:IBANDOL
