...
20062  BX=19:BY=19:BW=20:BH=5:FRAME
20064  PRINT AT(BY+1,BX+1) "RANSPORT EW ORK";
20066  PRINT AT(BY+2,BX+1) "RANSPORT ONDON";
20068  PRINT AT(BY+3,BX+1) "USGANG";
...
20160  BX=1:BY=19:BW=17:BH=5:FRAME
20165  PRINT AT(BY+1,BX+1) "AUER:  XX AGE";
20170  PRINT AT(BY+2,BX+1) "ENGE:";
20175  PRINT AT(BY+3,BX+1) "0000 LLES";
...
20350  T$(T1)=CHR$(4)+CHR$(CP)+CHR$(T2)+CHR$(T3)+CHR$(T4)+CHR$(ID)
