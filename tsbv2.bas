...
1052  DIM F%(1,6),BD$,I,I1,DT%(3),DC(11),TR$(13),P(1),SC%(8,1,3),SE%(1,4,3),AD%(2,1),PB%(3)
1054  DIM LV%(8,3,2),WK%(8,3,1),PC(8,3,1),PE(1,3),LQ(3),QE(3),RR(4),AR$(7,2),AK$(7),AC$(3,7)
1055  DIM YO(74)
1056  F=11:FS=12:FB=6:ID=0:MI=0:AA$="QWERX"


# ARTWORK STUFF
1100 AR$(0,0)="VITAMIN.BIN":AR$(0,1)="FLOWER.BIN":AR$(0,2)="OK.BIN"

1101 AK$(0)="JMIN":AK$(1)="KAT 2":AK$(2)="KAT 3":AK$(3)="KAT 4":AK$(4)="KAT 5"
1102 AK$(5)="KAT 6":AK$(6)="KAT 7":AK$(7)="KAT 8"

1103 AC$(0,0)=CHR$(1)+CHR$(2)+CHR$(0):AN$(0,0)=CHR$(2)+CHR$(0)+CHR$(1)


# LOOKUP TABLE FOR Y OFFSETS ON SCREEN (Y*40)
1105 FORX=0TO24:YO(X)=DISPLAY+40*X:NEXT
...
14335   PRINT AT(BY+4+X,BX+1) "#XX "AR$(AC,IX);
14350  NEXT
...
14805  PRINT ""CHR$(142);
14810  SCRLD DEF $CC,4,0,2:SCRLD 1,USE,2,AR$(AC,AS):SCRLD RESTORE
