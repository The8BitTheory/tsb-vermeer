...
131 BX=1:BY=1:TX=52:GOSUB 1100:GOSUB 1050

#4 HUB PLA - LAST VISIT DATA
140 BX=1:BY=12:BW=22:BH=12:GOSUB 1000:GOSUB 1050

#5 TRAVELCOST DIALOG
150 BX=1:BY=21:BW=24:BH=3:GOSUB 1000:GOSUB 1050
...
200 BX=1:BY=15:BW=22:BH=6:GOSUB 1000:GOSUB 1050
...
270 BX=19:BY=19:BW=20:BH=5:GOSUB 1000:GOSUB 1050
...
310 BX=1:BY=17:BW=24:BH=6:GOSUB 1000:GOSUB 1050

#22 TRAVEL PROGRESS FRAME (SHIPS AND TRAINS)
320 BX=1:BY=1:BW=38:BH=5:GOSUB 1000:GOSUB 1050
...
360 BX=30:BY=17:BW=9:BH=7:GOSUB 1000:GOSUB 1050

#27 MONTHLY REPORT
370 BX=1:BY=1:BW=38:BH=14:GOSUB 1000:GOSUB 1050
...
1120  POKE PA+OS+IO,1:POKEPA+OS+IO+1,BX:POKEPA+OS+IO+2,BY:POKEPA+OS+IO+3,TX
