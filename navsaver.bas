...
# 4=BANK-KREDITE. ENTRIES ONLY OPEN QUANTITY SELECTOR
1209  
...
1235  RO%(24,1,0)=26:RO%(24,1,1)=27:RO%(24,1,2)=6
# BANK - KREDITE:TILGEN/AUFNEHMEN/AUSGANG - NO GENERIC BEHAVIOR, OPENS QUANTITY SELECTOR
#1236  RO%(25,1,0)=
# 26 SHOWS QUANTITY SELECTOR
#1237  RO%(26)=
...
# 4 IS DEFINED BELOW IN LINE 1283


1258  RO%(5,0,0)=0:RO%(5,0,1)=-1
1260  RO%(6,0,0)=27:RO%(6,0,1)=28:RO%(6,0,2)=29:RO%(6,0,3)=0
...
# BANK - REEDEREIEN:ANKAUF/VERKAUF/AUSGANG
1281  RO%(23,0,0)=12:RO%(23,0,1)=13:RO%(23,0,1)=0
# BANK - DOLLAR:ANKAUF/VERKAUF/AUSGANG
1282  RO%(24,0,0)=12:RO%(24,0,1)=13:RO%(24,0,2)=0
# BANK - KREDITE:TILGEN/AUFNEHMEN/AUSGANG
1283  RO%(4,0,0)=30:RO%(4,0,1)=31:RO%(4,0,2)=0
...
1473  CM%(21,0)=10:CM%(21,1)=4
1474  CM%(22,0)=10:CM%(22,1)=4
1475  CM%(23,0)=10:CM%(23,1)=2
1476  CM%(24,0)=10:CM%(24,1)=2
1477  CM%(4,0)=10:CM%(4,1)=2
